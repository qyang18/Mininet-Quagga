...
if __name__ == "__main__":
    ...
    file1.append(getLogFile('./TwoWayTest2Server'))
    # plot(p,file1,1,7,'r','Mix CenterPhysical',1)
    plot(p,file1,1,1,'r','TwoWayTest H1',1)

    file2.append(getLogFile('./TwoWayTest2Client'))
    plot(p, file2, 1, 1, 'b', 'TwoWayTest H2', 1)
